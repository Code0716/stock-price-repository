...
func newNotificationHistory(db *gorm.DB, opts ...gen.DOOption) notificationHistory {
	...
	_notificationHistory.notificationHistoryDo.UseModel(&gen_model.NotificationHistory{})
	...
	_notificationHistory.Source = field.NewString(tableName, "source")
	_notificationHistory.ChannelID = field.NewString(tableName, "channel_id")
	_notificationHistory.ChannelLabel = field.NewString(tableName, "channel_label")
	_notificationHistory.Title = field.NewString(tableName, "title")
	_notificationHistory.Body = field.NewString(tableName, "body")
	_notificationHistory.SentAt = field.NewTime(tableName, "sent_at")
	_notificationHistory.CreatedAt = field.NewTime(tableName, "created_at")
...
type notificationHistory struct {
	...
	Source       field.String // 送信元サービス: spr/stt
	ChannelID    field.String // Slack チャンネル ID または #名前（既存 SlackChannelName 定数の値そのまま）
	ChannelLabel field.String // チャンネル表示名。front が名前解決せず表示するため送信時に確定させて保存
	Title        field.String // 通知タイトル（親メッセージ本文）
	Body         field.String // スレッド本文。SendMessage 系（固定文言のみ）は NULL
	SentAt       field.Time   // Slack 送信日時
...
func (n *notificationHistory) updateTableName(table string) *notificationHistory {
	...
	n.ChannelID = field.NewString(table, "channel_id")
	n.ChannelLabel = field.NewString(table, "channel_label")
...
func (n *notificationHistory) fillFieldMap() {
	...
	n.fieldMap["channel_id"] = n.ChannelID
	n.fieldMap["channel_label"] = n.ChannelLabel
...
type INotificationHistoryDo interface {
	...
	Create(values ...*gen_model.NotificationHistory) error
	CreateInBatches(values []*gen_model.NotificationHistory, batchSize int) error
	Save(values ...*gen_model.NotificationHistory) error
	First() (*gen_model.NotificationHistory, error)
	Take() (*gen_model.NotificationHistory, error)
	Last() (*gen_model.NotificationHistory, error)
	Find() ([]*gen_model.NotificationHistory, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.NotificationHistory, err error)
	FindInBatches(result *[]*gen_model.NotificationHistory, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gen_model.NotificationHistory) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gen_model.NotificationHistory, error)
	FirstOrCreate() (*gen_model.NotificationHistory, error)
	FindByPage(offset int, limit int) (result []*gen_model.NotificationHistory, count int64, err error)
...
func (n notificationHistoryDo) Create(values ...*gen_model.NotificationHistory) error {
	if len(values) == 0 {
		return nil
	}
...
func (n notificationHistoryDo) CreateInBatches(values []*gen_model.NotificationHistory, batchSize int) error {
	return n.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (n notificationHistoryDo) Save(values ...*gen_model.NotificationHistory) error {
	if len(values) == 0 {
		return nil
	}
...
func (n notificationHistoryDo) First() (*gen_model.NotificationHistory, error) {
	if result, err := n.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gen_model.NotificationHistory), nil
	}
}

func (n notificationHistoryDo) Take() (*gen_model.NotificationHistory, error) {
...
func (n notificationHistoryDo) Last() (*gen_model.NotificationHistory, error) {
...
func (n notificationHistoryDo) Find() ([]*gen_model.NotificationHistory, error) {
	result, err := n.DO.Find()
	return result.([]*gen_model.NotificationHistory), err
}

func (n notificationHistoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.NotificationHistory, err error) {
	buf := make([]*gen_model.NotificationHistory, 0, batchSize)
...
func (n notificationHistoryDo) FindInBatches(result *[]*gen_model.NotificationHistory, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (n notificationHistoryDo) FirstOrInit() (*gen_model.NotificationHistory, error) {
...
func (n notificationHistoryDo) FirstOrCreate() (*gen_model.NotificationHistory, error) {
...
func (n notificationHistoryDo) FindByPage(offset int, limit int) (result []*gen_model.NotificationHistory, count int64, err error) {
...
func (n notificationHistoryDo) Delete(models ...*gen_model.NotificationHistory) (result gen.ResultInfo, err error) {
