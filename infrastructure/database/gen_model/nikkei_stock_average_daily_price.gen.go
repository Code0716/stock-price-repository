...
const TableNameNikkeiStockAverageDailyPrice = "nikkei_stock_average_daily_price"

// NikkeiStockAverageDailyPrice mapped from table <nikkei_stock_average_daily_price>
...
// TableName NikkeiStockAverageDailyPrice's table name
func (*NikkeiStockAverageDailyPrice) TableName() string {
	return TableNameNikkeiStockAverageDailyPrice
}
