...
const TableNameTopixDailyPrice = "topix_daily_price"

// TopixDailyPrice mapped from table <topix_daily_price>
...
// TableName TopixDailyPrice's table name
func (*TopixDailyPrice) TableName() string {
	return TableNameTopixDailyPrice
}
