...
func newSchemaMigration(db *gorm.DB, opts ...gen.DOOption) schemaMigration {
	...
	_schemaMigration.schemaMigrationDo.UseModel(&gen_model.SchemaMigration{})
...
type ISchemaMigrationDo interface {
	...
	Create(values ...*gen_model.SchemaMigration) error
	CreateInBatches(values []*gen_model.SchemaMigration, batchSize int) error
	Save(values ...*gen_model.SchemaMigration) error
	First() (*gen_model.SchemaMigration, error)
	Take() (*gen_model.SchemaMigration, error)
	Last() (*gen_model.SchemaMigration, error)
...
func (s schemaMigrationDo) Create(values ...*gen_model.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) CreateInBatches(values []*gen_model.SchemaMigration, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s schemaMigrationDo) Save(values ...*gen_model.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) First() (*gen_model.SchemaMigration, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gen_model.SchemaMigration), nil
	}
}

func (s schemaMigrationDo) Take() (*gen_model.SchemaMigration, error) {
...
func (s schemaMigrationDo) Last() (*gen_model.SchemaMigration, error) {
...
func (s schemaMigrationDo) Find() ([]*gen_model.SchemaMigration, error) {
	result, err := s.DO.Find()
	return result.([]*gen_model.SchemaMigration), err
}

func (s schemaMigrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.SchemaMigration, err error) {
	buf := make([]*gen_model.SchemaMigration, 0, batchSize)
...
func (s schemaMigrationDo) FindInBatches(result *[]*gen_model.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s schemaMigrationDo) FirstOrInit() (*gen_model.SchemaMigration, error) {
...
func (s schemaMigrationDo) FirstOrCreate() (*gen_model.SchemaMigration, error) {
...
func (s schemaMigrationDo) FindByPage(offset int, limit int) (result []*gen_model.SchemaMigration, count int64, err error) {
...
func (s schemaMigrationDo) Delete(models ...*gen_model.SchemaMigration) (result gen.ResultInfo, err error) {
